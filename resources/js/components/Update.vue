<template>
  <div class="container">
    <form action>
      <div :class="['form-group m-1 p-3', (successfull ? 'alert-success' : '')]">
        <span v-if="successfull" class="label label-sucess">Noticia actualizada!</span>
      </div>
      ...
      <button class="btn btn-primary" type="submit" @click.prevent="update">Actualizar &rarr;</button>
    </form>
  </div>
</template>
