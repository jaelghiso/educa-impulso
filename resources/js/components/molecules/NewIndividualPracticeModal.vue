<template>
    <modal name="new-individual-practice" classes="p-10 bg-card rounded-lg" height="auto" width="45%">
        <h1 class="font-normal mb-16 text-center text-2xl">
            Área Práctica Independiente
        </h1>
        <form @submit.prevent="submit">
                ...
                <div class="flex-1 mr-4">
                    <div class="mb-4">
                        <label
                            ...
                            >Introduce el título de la actividad:</label
                        >
                        <input
                            type="text"
                            id="title"
                    ...
                    <div class="mb-4">
                        <label
                            for="description"
                            class="text-default text-sm block mb-2"
                            >Texto Práctica Independiente</label
                        >
                        <vue-simplemde
                            rows="6"
                            id="description"
                ...
                <div class="flex-1 mr-4">
                    <div class="mb-4">
                        <label
                            for="title"
                            class="text-default text-sm block mb-2"
                            >Introduce una lista destacada:</label
                        >
                        <vue-simplemde
                            type="text"
                            id="title"
                    ...
                    <div class="mb-4">
                        <label class="text-default text-sm block mb-2"
                            >¿Necesitas agregar imágenes?</label
                        >
                        <input
                            type="file"
                            ref="image"
            ...
            <footer class="flex justify-end">
                <button
                    ...
                    @click.prevent="$modal.hide('new-individual-practice')"
                >
                    Cancelar
                </button>
                <button class="button">Ingresar Práctica Independiente</button>
            </footer>
        </form>
    </modal>
</template>
